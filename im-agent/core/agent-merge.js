...
const MERGE = {
  ...
  '08_appraisal': {
    drop: [
      '감정평가 Agent · 3방식 가중평균',            // 옛 판 — 이미 쌓인 것을 치운다
      // ★ D-330 — 결론은 현 상태 방식만의 «잠정» 평균이다. 이름이 바뀌면 여기도 바꾼다 — 안 바꾸면 다시 돌 때 두 벌로 쌓인다
      '감정평가 Agent · 현 상태 1방식 가중평균(잠정)',
      '감정평가 Agent · 현 상태 2방식 가중평균(잠정)',
      '감정평가 Agent · 공시지가 기준',
      '감정평가 Agent · 거래사례비교법',
      '감정평가 Agent · 수익환원법',
    ],
