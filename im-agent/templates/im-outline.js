...
const IM_SECTIONS = [
  ...
  { no: '05', id: 'asset', title: 'Asset Overview', dataKeys: ['land.area_sqm', 'building.gfa_sqm', 'building.floors', 'capacity.it_load_mw', 'capacity.power_mw', 'capacity.pue', 'capacity.dc_kw', 'capacity.ac_kw', 'capacity.leasable_sqm', 'building.footprint_sqm', 'building.height_m', 'massing.far_planned', 'massing.gfa_allowed_sqm'], table: 'massing', narrative: true },
  { no: '06', id: 'location', title: 'Location Analysis', dataKeys: ['project.location', 'land.zoning', 'land.use_districts', 'geo.pnu', 'land.official_price', 'appraisal.land_value_concluded'], table: 'geo', narrative: true, research: 'location' },
  ...
  { no: '11', id: 'legal', title: 'Legal & Permit', dataKeys: ['legal.permit_status', 'land.ownership', 'land.zoning', 'land.use_districts', 'legal.spc'], narrative: true },
