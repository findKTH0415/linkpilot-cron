...
const IM_SECTIONS = [
  ...
  { no: '06', id: 'location', title: 'Location Analysis', dataKeys: ['project.location', 'land.zoning', 'geo.pnu', 'land.official_price', 'appraisal.land_value_concluded'], table: 'geo', narrative: true, research: 'location' },
