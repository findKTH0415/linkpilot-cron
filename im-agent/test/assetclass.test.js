...
/**
 * ★ 처음 12종은 사용자가 말한 목록이고, **풍력 2종은 2026-08-16 에 사용자가
 *   더한 것이다** (등록부 D-55). 늘어난 것을 조용히 넘기지 않으려고 여기에
 *   경위를 적는다 — 목록만 고치면 반년 뒤 "왜 14종이지"가 된다.
 * ★ **해상이 육상보다 앞에 있어야 한다.** `detect` 는 키워드 포함으로 찾는데
 *   육상(`풍력`)이 앞이면 「해상풍력」이 육상으로 잡힌다.
 */
test('★ 자산군 14종이 전부 있다 (12종 + 풍력 2종)', () => {
