...
(function (root, factory) {
  ...
  var STEPS = [
    ...
    /**
     * ★★★ **「생성」을 따로 세지 않는다** 〈2026-08-22 사용자 지시 — 단계는 셋〉.
     *
     *   앞 판은 넷이었다: 입력 · 필드 · 출력조건 · **생성**. 그런데 넷째는
     *   **셋째와 같은 화면**(`reports.html`)이고, 확정을 누르면 그 자리에서
     *   모습만 바뀐다. 옮겨 갈 곳이 없는 칸을 레일에 그려 두면 사용자는
     *   **「한 칸이 더 남았다」**로 읽고 다음을 찾는다 — 찾을 것이 없다.
     *
     *   ★ 없앤 것은 **레일의 칸**이지 기능이 아니다. 확정→생성은 그대로다.
     *     출력조건 칸의 설명이 그 사실을 말한다.
     */
    {
  ...
  var SECTIONS = [
    ...
    {
      no: 4, id: 'output', name: '출력조건', steps: ['spec'],
