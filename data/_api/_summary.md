...
**잰 시각** 2026. 9. 20. 16시 50분 38초 · **잰 곳** GitHub Actions (열쇠가 있는 자리)
...
| `DATA_GO_KR_KEY` 또는 `APIS_DATA` 또는 `SPECIAL_DAY_INFO` | 공공데이터포털 | 실거래가·건축물대장·인허가·특일정보 (이름 셋 다 읽는다 — connectors/datakey.js) | ✅ `DATA_GO_KR_KEY` |
...
| 기업기본정보 (금융위) | ✅ 살아 있음 | — | — |
| 공사 낙찰 (조달청) | ✕ 실패 | 조회는 됐지만 조건에 맞는 낙찰 건이 없다 (기간 20250920~20260920 · 지역 인천 · 10억  | 아래 진단 원문을 보십시오 |
